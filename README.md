...
You can find instructions on how to install and run ts-migrate in the [main package](./packages/ts-migrate/). If you find any [issues](https://github.com/patryk-w-bl/ts-migrate/issues) or have ideas for improvements, we welcome your [contributions](https://github.com/patryk-w-bl/ts-migrate/blob/master/CONTRIBUTING.md)!
...
MIT, see [LICENSE](https://github.com/patryk-w-bl/ts-migrate/blob/master/LICENCE) for details.
